...
const endpointDefinitions = [
  ...
  },
  {
    ...
    method: "post",
    tags: ["Rides"],
    summary: "Create a ride and assign the nearest driver",
    description: "Creates a ride request, selects the nearest available driver, and returns the assigned ride.",
    auth: true,
    requestExample: rideRequestExample,
    successStatus: 201,
    successDescription: "Ride created and nearest driver assigned",
  },
  {
